...
def get_hospitality_diagnosis_page(lang: str) -> dict:
    if lang == "es":
        return {
            ...
            "lbl_numotas": "¿Con cuántas agencias trabajas? (Booking, Expedia, etc.)",
            "lbl_ota_name": "Canal",
            "lbl_ota_comm": "%",
            ...
            "tp_numotas": "Cuenta las agencias con las que vendes de forma habitual.",
    ...
    return {
        ...
        "lbl_occ": "Occupancy %",
        "occ_placeholder": "1–100",
        "lbl_numotas": "How many agencies do you work with? (Booking, Expedia, etc.)",
        ...
        "tp_numotas": "Count the agencies you regularly sell through.",
