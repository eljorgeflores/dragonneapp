...
async def _hospitality_diagnosis_submit(request: Request, lang: str) -> JSONResponse:
    ...
    sent = send_hospitality_diagnosis_report(
        ...
        savings_badge=str(diag_ui.get("res_savings_badge") or ""),
        savings_hook=str(diag_ui.get("res_savings_hook") or ""),
        savings_formula_label=str(diag_ui.get("res_savings_formula_label") or ""),
        growth_cap=str(diag_ui.get("res_growth_cap") or ""),
        growth_badge=str(diag_ui.get("res_growth_badge") or ""),
        growth_hook=str(diag_ui.get("res_growth_hook") or ""),
        growth_formula_label=str(diag_ui.get("res_growth_formula_label") or ""),
        total_line=total_line,
        total_cap=str(diag_ui.get("res_total_cap") or ""),
        total_badge=str(diag_ui.get("res_total_badge") or ""),
        total_hook=str(diag_ui.get("res_total_hook") or ""),
        trust_line=str(diag_ui.get("res_trust_line") or ""),
        disclaimer_short=str(diag_ui.get("res_disclaimer_short") or ""),
        cta_note=str(diag_ui.get("success_cta_note") or ""),
